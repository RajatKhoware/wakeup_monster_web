...
class MyCustomRectanglePainter extends CustomPainter {
  final Color color;

  // Constructor now requires a color
  MyCustomRectanglePainter({required this.color});
  ...
  @override
  bool shouldRepaint(covariant CustomPainter oldDelegate) {
    // If your painter depends on the color property, you may want to update
    // the logic here to repaint when the color changes.
    if (oldDelegate is MyCustomRectanglePainter) {
